...
// Generate integer unix timestamps on compile time
// (This does not rely on an hardware RTC, or external includes)
// This is useful if we want to erase the EEPROM every time we compile and upload the firmware, but NOT on a power cycle or reset!
