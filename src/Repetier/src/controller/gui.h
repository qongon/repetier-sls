...
#define GUI_DIRECT_ACTION_CLICKED_HIDDEN_DEVELOPER 35
#define GUI_DIRECT_ACTION_STOP_HOST_PRINT 36
#define GUI_DIRECT_ACTION_PAUSE_HOST_PRINT 37
#define GUI_DIRECT_ACTION_CONTINUE_HOST_PRINT 38
